...
export const RenderShazamData = ({ data }) => {
    ...
    return (
        ...
        >
            ...
            <h4 className='bg-blue-400 text-red-600 text-4xl px-2 py-4 m-auto'>Listen to this Music from <a className='text-blue-600' target={"_blank"} href={href}>Shazam</a></h4>
        </section>
    )
}
